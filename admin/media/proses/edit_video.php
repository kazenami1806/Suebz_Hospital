        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <form method="POST" action="m_edit_video.php?id_video=<?php echo $id_video; ?>" enctype="multipart/form-data">
                                <div class="mb-2">
                                    <label for="name_vid" class="form-label">Nama video :</label>
                                    <input type="text" class="form-control" id="name_vid" name="name_vid" value="<?php echo isset($video['name_vid']) ? $video['name_vid'] : ''; ?>" required>
                                </div>
                                <div class="mb-2">
                                    <label for="notes_v" class="form-label">Keterangan video :</label>
                                    <input type="text" class="form-control" id="notes_v" name="notes_v" value="<?php echo isset($video['notes_v']) ? $video['notes_v'] : ''; ?>" required>
                                </div>
                                <div class="mb-1">
                                    <label for="vid" class="form-label">video :</label>
                                    <br><vid src="../../../img/video/<?php echo isset($video['vid']) ? $video['vid'] : ''; ?>" width=30% style="margin-bottom: 10px;">
                                </div>
                                <div class="mb-4">
                                    <label for="vid" class="form-label">Ganti video :
