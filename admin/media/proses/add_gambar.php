        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <form method="POST" action="m_add_gambar.php" enctype="multipart/form-data">
                                <div class="mb-2">
                                    <label for="name_img" class="form-label">Nama Gambar :</label>
                                    <input type="text" class="form-control" id="name_img" name="name_img" required>
                                </div>
                                <div class="mb-2">
                                ...
                                <div class="mb-4">
                                    <label for="img" class="form-label">Upload Gambar :<div id="passwordHelpBlock" class="form-text mt-1">
