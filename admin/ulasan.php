...
<body class="sb-nav-fixed">
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="ulasan" class="table table-bordered hover">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Name</th>
                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_assoc($data)) {
                                        echo "<tr>
                                                ...
                                                <td>" . $row['email'] . "</td>
                                                <td>" . $row['subject'] . "</td>
                                                <td>" . substr( $row['message'] , 0, 15) ."...</td>
                                                <td><button class='btn btn-primary' onclick=\"location.href='ulasan_detail.php?id=" . $row['id'] . "'\">Details</button></td>
                                                </tr>";
                                        $no++;
                                    }
                                    ?>
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid px-4">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Copyright &copy; SUEBS Hospital 2023</div>
                    </div>
                </div>
            </footer>
        </div>
    ...
    <script>
        new DataTable('#ulasan', {
            columnDefs: [ { className: 'dt-center', width: 20, targets: 0 },
